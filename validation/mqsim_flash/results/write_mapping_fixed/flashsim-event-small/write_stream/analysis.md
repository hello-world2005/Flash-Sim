...
- Case: `write_stream`
- Status: `FAIL`
- Main request count: expected=2, Flash-Sim=2
- MQSim trace request count: expected=2 (warmup=0), MQSim=2, serviced=0
- Main read/write requests: expected=0/2, Flash-Sim=0/2, MQSim trace expected=0/2, MQSim=0/2

## Timing Snapshot

| Metric | Flash-Sim (us) | MQSim (us) |
| --- | ---: | ---: |
| Overall host/device avg | 1.31 | 0.00 |
| Read host/transaction avg | 0.00 | 0.00 |
| Write host/transaction avg | 1.31 | 125.00 |
| Read media service avg | 0.00 | 0.00 |
| Write media service avg | 251.90 | 125.00 |
| Flash-Sim read host p95 | 0.00 | n/a |
| Flash-Sim read host p99 | 0.00 | n/a |
| Flash-Sim write host p95 | 1.31 | n/a |
| Flash-Sim write host p99 | 1.31 | n/a |

## Maintenance And Mapping Diagnostics

- Flash-Sim maintenance: {'gc_count': 0, 'static_wl_count': 0, 'gc_relocated_pages': 0, 'gc_erased_blocks': 0, 'host_write_pages': 2, 'physical_user_write_pages': 2, 'physical_gc_write_pages': 0, 'min_free_pool': 0, 'max_wear_skew': 0, 'current_waiting_writes': 0, 'max_waiting_writes': 0, 'backpressure_enqueued': 0, 'backpressure_retried': 0, 'backpressure_wait_time': 0, 'precondition': {'mode': 'manual', 'source': '$FLASHSIM_ROOT/pre_data/precondition_data.json', 'input_pages': 50, 'actual_pages': 39, 'actual_fill_ratio': 0.00021216869042956, 'preconditionable_pages': 183816, 'dropped_pages': 0, 'non_empty_planes': 38, 'plane_actual_min': 0, 'plane_actual_max': 2, 'cmt_warm_pages': 39}, 'planes': {}, 'write_amplification': 1.0}
...
- MQSim serviced request count 0 != expected trace count 2.
