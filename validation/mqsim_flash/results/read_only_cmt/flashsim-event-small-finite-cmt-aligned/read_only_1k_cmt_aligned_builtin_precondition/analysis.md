...
- Case: `read_only_1k_cmt_aligned_builtin_precondition`
- Status: `FAIL`
- Main request count: expected=1000, Flash-Sim=1000
- MQSim trace request count: expected=1000 (warmup=0), MQSim=None, serviced=None
- Main read/write requests: expected=1000/0, Flash-Sim=1000/0, MQSim trace expected=1000/0, MQSim=None/None
...
- MQSim preconditioning: True, initial occupancy=1
- MQSim warmup prefix: enabled=False, requests=0, gap_ns=0, main_time_shift_ns=0

## Timing Snapshot

| Metric | Flash-Sim (us) | MQSim (us) |
| --- | ---: | ---: |
| Overall host/device avg | 12.06 | n/a |
| Read host/transaction avg | 12.06 | n/a |
| Write host/transaction avg | 0.00 | n/a |
| Read media service avg | 6.86 | n/a |
| Write media service avg | 0.00 | n/a |
...
- MQSim scenario report was not produced.
- MQSim exited with -8.
