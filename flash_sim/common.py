...
# ----- 常量 -----
CMT_SIZE = int(os.environ.get("FLASHSIM_CMT_SIZE", "64"))
LPA_NO_PER_SECTOR = 4
...
PCIE_TLP_MAX_PAYLOAD_BYTES = 128
PCIE_TLP_PACKET_OVERHEAD_BYTES = 28
PCIE_NVME_SQ_ENTRY_BYTES = 72
PCIE_NVME_CQ_ENTRY_BYTES = 16
